...
public class BackgroundStepDef {
	...
	public void user_checks_user_first_name_is_present(String userName) throws InterruptedException{
		String userNameActual =driver.findElement(By.xpath("//input[@name='firstname']")).getAttribute("value");//we use getattribute value to pull the value from the text box not from dom structure becoz some times value is not present in dom structure
